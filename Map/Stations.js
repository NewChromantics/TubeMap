...
//StationStopPoints.ANG$=$'940GZZLUAGL';//	angel
...
export const StationStopPoints =
{
	...
	Caledonian$Road$And$Barnsbury:		"910GCLDNNRB",
	...
	Eden$Park:		"910GEDPK",
	Edgware:		"940GZZLUEGW",
	Edgware$Road$_Bakerloo_:		"940GZZLUERB",
	Edgware$Road$_Circle_:		"940GZZLUERC",
	Edmonton$Green:		"910GEDMNGRN",
	Elephant$And$Castle:		"910GELPHNAC",
	Elephant$And$Castle$_Underground_:		"910GELPHNAC",
	...
	Hammersmith$_District$and$Piccadilly:		"940GZZLUHSC",
	...
	Harrow$And$Wealdstone:		"910GHROW",
	Harrow_on_the_Hill:		"910GHAROOTH",
	Hatch$End:		"910GHTCHEND",
	Haydons$Road:		"910GHYDNSRD",
	Hayes$And$Harlington:		"910GHAYESAH",
	...
	Southwark:		"910GWLOE",
	St$Helier$_Surrey_:		"910GSHLIER",
	St$James$Street:		"910GSTJMSST",
	St$Jamess$Park:		"940GZZLUSJP",
	St$Johns$_London_:		"910GSTJOHNS",
	St$Johns$Wood:		"940GZZLUSJW",
	St$Margarets$_London_:		"910GSTMGTS",
	...
	Streatham$_Greater$London_:		"910GSTRETHM",
	Streatham$Common:		"910GSTRHCOM",
	Streatham$Hill:		"910GSTRHILL",
	Sudbury$And$Harrow$Road:		"910GSDBRYHR",
...
export default StationStopPoints;


const DollarToSpace = new RegExp('\\$','g');		//	global replace
const UnderscoreToDash = new RegExp('_','g');	//	global replace

function FormatStationName(Name)
{
	Name = Name.replace(DollarToSpace,' ');
	Name = Name.replace(UnderscoreToDash,'-');
	return Name;
}

export const StationFormattedNames = {};
Object.keys(StationStopPoints).map( Key => StationFormattedNames[Key] = FormatStationName(Key) );
